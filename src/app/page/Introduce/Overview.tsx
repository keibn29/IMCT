...
const Overview = () => {
  return (
    <>
      <Flex className="py-[100px] background-image introduce-bg" justify="center">
        <div className="container">
          <Title className="z-[2] relative" title="Giới Thiệu" isWhite={true} title2="Trang chủ/Giới Thiệu" />
        </div>
      </Flex>
      <Flex className="bg-light-gray py-[70px]" justify="center">
        <Row className="container" justify="space-between">
          <Col className="p-[30px] relative shadow-default bg-white">
            <div className="background-image introduction w-[482px] h-[482px] relative z-[2]" />
          ...
          <Col span={13} className="py-[50px]">
            <Flex vertical gap={20}>
              <Flex align="center" gap={15}>
                <span className="text-[40px] font-bold font-['Inter']">Tổng Quan</span>
            ...
            <Flex vertical gap={20} className="mt-[20px]">
              <Flex align="center" gap={15}>
                <span className="text-[40px] font-bold font-['Inter']">Sứ Mệnh</span>
                <HorizontalIntro className="mt-[3px]" />
              </Flex>
              <p className="text-justify text-black text-sm font-normal font-['Inter']">
